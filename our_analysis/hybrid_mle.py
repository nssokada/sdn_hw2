...
def fit_hybrid_mixed_fixedAlpha_model(data_df, stan_file="equalLearning_mle.stan", output_file=None, noptim=NOPTIM):
...
def fit_hybrid_mixed_model_decayingMF(data_df, stan_file="decaying_mf_weight.stan", output_file=None, noptim=NOPTIM):
